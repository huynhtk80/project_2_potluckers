    ...
    <>
      <div className="footer-container">
        ...
        <div className="footer-body">
          ...
          <ul>
            ...
            <li className="footer-list">
              <p>
                ...
                in this Agreement) refers to Kamikaze Cheese, 800 3 St SE 3rd
                Floor, Calgary, AB T2G 0E7.
              </p>
            </li>
            <li className="footer-list">
              <p>
            ...
            <li className="footer-list">
              <p>
                <strong>Website</strong> refers to Potlucker, accessible from{" "}
                <a
                  href="http://www.potlucker.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  http://www.potlucker.com
                </a>
              </p>
            </li>
            <li className="footer-list">
          ...
          <ul>
            <li className="footer-list">Comply with a legal obligation</li>
            <li className="footer-list">
            ...
            <li className="footer-list">Protect against legal liability</li>
          </ul>
          ...
          <ul>
            <li className="footer-list">
              ...
              <a
                href="http://www.potlucker.com/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://www.potlucker.com/contact
              </a>
            </li>
            <li className="footer-list">
