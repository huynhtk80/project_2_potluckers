...
function Aboutus() {
  return (
    ...
    <div className="aboutus-firstbox">      
      <div className="aboutus-main">
        <span className="title-main"><h1>Potluck made easy</h1></span>
            <br />
            <p><i>One cannot think well, love well, sleep well, if one has not dined well.</i> Virginia Woolf</p>
            <br />
            <p>Organizing potlucks can be challenging. You need to know
              ...
              to deliver food goodness to everybody in a quick and easy manner.</p>
            <br />
    ...
    <div className="aboutus-secondbox">
      ...
      <img src={hgroup} alt="group" width={600} height={700} style={{objectFit:"cover"}}/>
      </div>
      <div className="aboutus-main2">
        <span className="title-main"><h1>The art of good Food</h1></span>
            <br />
            <p>Our team core value is food and doing good. The Potlockers app
              will allow you to add/remove foods from your potlock list. In
              addition, you can look up recipes for the food you are bringing,
              ...
              can never forget. Bon appétit!</p>
            <br />
